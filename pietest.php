//**************************************
    ...
    // Description:Simple class that uses GD
    //     to draw pie charts. After the class defi
    //     nition there's some sample code to demon
    //     strate how you use the class. by Bjørn B
    //     orud
    ...
    */
    ...
    $this->draw_legends(2);
    #$this->draw_margins();
    ImageJPEG($this->im, "/tmp/pie.JPEG");
