...
<td>
	<form name="form1" method="post" action="find.php">
	  ...
	  <p><strong><font size="+1">Search By Server Name or IP:</font></strong> </p>
  ...
  <p><strong><font size="+1">Search By Type (Windows, Domain, BDC, etc..)</font></strong>  </p>
...
<form name="form3" method="post" action="searchwild.php">
  <p><strong><font size="+1">Search By Wild Card (Example &quot;158.73.85 Returns All <br>Servers in that subnet) No * are necessary in your search string. </font></strong></p>
  <strong>Query:
<input type="text" name="Type">
</strong>
 <br>
      <input type="submit" name="Submit33" value="Submit">
...
<p><a href="../TSWeb/default.htm"><font size="+1">Connect to Server via Terminal 
  Services</font></a></p>
<p><a href="dnsstat.php"><font size="+1">View DNS Historical Performance Data </font></a></p>
<p><a href="dns.htm"><font size="+1">Test DNS Servers </font></a></p>
...
<p><a href="../phone" target="_blank"><font size="+1">Additional Contacts </font></a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></td>
  </tr>
